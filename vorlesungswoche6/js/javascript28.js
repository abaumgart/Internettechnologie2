...
function buttonErzeugen()
	{
		...
		tabellenReihenLoschenButton.classList.add('loeschen');
		...
		const tabellenErstellenButton=document.createElement('button');
		tabellenErstellenButton.setAttribute('id', 'createTableButton');
		tabellenErstellenButton.classList.add('erstellen');
		buttonBeschriftung=document.createTextNode('Tabelle erzeugen');
		
		tabellenErstellenButton.appendChild(buttonBeschriftung);
		mainContent.appendChild(tabellenErstellenButton);
	}
